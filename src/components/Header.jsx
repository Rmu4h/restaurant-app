        ...
        >
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "roman.shevchuk.job@gmail.com" && (
                  <Link to={'/createItem'} className="px-4 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-200 transition-all duration-100 ease-in-out text-textColor text-base"
